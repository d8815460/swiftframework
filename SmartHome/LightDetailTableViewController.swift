...
class LightDetailTableViewController: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            cell = tableView.dequeueReusableCellWithIdentifier("customCell", forIndexPath: indexPath) as! CustomDeviceCell
        } else if indexPath.row == 1 {
            cell = tableView.dequeueReusableCellWithIdentifier("colorPickerCell", forIndexPath: indexPath) as! ColorPickerCell
        }
