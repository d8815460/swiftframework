...
/// 
/// </code>
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull disabledDistanceHandlingClasses;
...
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull enabledDistanceHandlingClasses;
...
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull disabledToolbarClasses;
...
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull enabledToolbarClasses;
...
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull toolbarPreviousNextAllowedClasses;

/// Disabled classes to ignore 'shouldResignOnTouchOutside' property, Class should be kind of UIViewController.
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull disabledTouchResignedClasses;
...
@property (nonatomic, copy) NSSet<NSString *> * _Nonnull enabledTouchResignedClasses;
...
- (void)disableDistanceHandlingInViewControllerClass:(Class _Nonnull)disabledClass;
...
- (void)removeDisableDistanceHandlingInViewControllerClass:(Class _Nonnull)disabledClass;
...
/// 
/// </code>
- (void)addTextFieldViewDidBeginEditingNotificationName:(NSString * _Nonnull)didBeginEditingNotificationName didEndEditingNotificationName:(NSString * _Nonnull)didEndEditingNotificationName;
@end
...
/// <hr/>
/// <h2>MARK: Private helper</h2>
+ (IQBarButtonItem * _Nonnull)flexibleBarButtonItem;
