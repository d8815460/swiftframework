...
@objc public protocol FlexibleTableViewDelegate: NSObjectProtocol {
    ...
    optional func tableView(tableView: FlexibleTableView, didDeselectSubRowAtIndexPath indexPath: FlexibleIndexPath)
...
public class FlexibleTableView : UITableView, UITableViewDelegate, UITableViewDataSource {
    ...
    public func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        func menuTitle() -> NSArray {
            return ["IP Hubs", "IP Camera", "Account", "Help", "About"]
        }
        ...
        if correspondingIndexPath.subRow == 0 {
            ...
            myCustomSelectionColorView.backgroundColor = DefauleTheme.SubColor
    ...
    public func tableView(tableView: UITableView, didDeselectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        flexibleTableViewDelegate.tableView!(self, didDeselectSubRowAtIndexPath: correspondingIndexPath)
    }
